/*
 * result_of_message_object.h
 *
 * 
 */

#ifndef _result_of_message_object_H_
#define _result_of_message_object_H_
...
typedef struct result_of_message_object_t {
    int code; //numeric
    message_object_t *data; //model
    char *errmsg; // string
...
#endif /* _result_of_message_object_H_ */
